...
function PlausibleProvider(props) {
    ...
    const proxyOptions = (_b = (_a = getConfig()) === null || _a === void 0 ? void 0 : _a.publicRuntimeConfig) === null || _b === void 0 ? void 0 : _b.nextPlausiblePublicProxyOptions;
    return (React.createElement(React.Fragment, null,
        enabled && (React.createElement(Script, Object.assign({ async: true, defer: true, "data-api": proxyOptions ? getApiEndpoint(proxyOptions) : undefined, "data-domain": props.domain, "data-exclude": props.exclude, src: (proxyOptions ? '' : domain) +
